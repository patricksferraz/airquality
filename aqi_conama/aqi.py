...
terrible = {
    ...
    Pollutant.SO2: (Decimal(1600.1), Decimal(2100.0)),
    Pollutant.NO2: (Decimal(2260.1), Decimal(3000)),
    Pollutant.CO: (Decimal(30.1), Decimal(40)),
    Pollutant.O3: (Decimal(400.1), Decimal(600)),
}
critical = {
    "idx": (Decimal(401), Decimal(math.inf)),
    Pollutant.PM10: (Decimal(501), Decimal(math.inf)),
    Pollutant.PM25: (Decimal(251), Decimal(math.inf)),
    Pollutant.SO2: (Decimal(2101), Decimal(math.inf)),
    Pollutant.NO2: (Decimal(3001), Decimal(math.inf)),
    Pollutant.CO: (Decimal(41), Decimal(math.inf)),
    Pollutant.O3: (Decimal(601), Decimal(math.inf)),
}
